...
int main(int argc, char *argv[]) {
	...
	int i,j,l/*array indices*/,flag/*game over*/,score,newi,newj,newnum/*indices and magnitude of new number*/,move/*next move*/;
	score=0;
	flag=0;
	srand( time( NULL ) ); /*seed the pseudo random number generatot with current time*/
	...
	while (flag==0) {
		flag=1;
		/*read next move*/	
		/*search the internet for getch() or kbhit() function to use arrow keys without pressing ENTER*/
		move=getch();
